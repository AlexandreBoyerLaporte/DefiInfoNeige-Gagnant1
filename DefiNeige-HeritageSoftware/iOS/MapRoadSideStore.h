...
@interface MapRoadSideStore : NSObject

+ (void)mapRoadSidesNearLocation:(CLLocationCoordinate2D)location
                      completion:(void (^)(NSArray *mapRoadSides, NSError *error))block;

+ (void)mapRoadSideForRoadSideID:(NSInteger)roadSideID
                      completion:(void (^)(MapRoadSide *mapRoadSide, NSError *error))block;
